...
const Footer = () => {
  return (
    <div className='flex  md:justify-between border-t border-t-stroke'>
      <div className='flex '>
        <p className='p-5 lg:p-3 text-2xl lg:text-sm text-text-foreground mr-1.5 md:mr-0' >Find me in: </p>
        <p className='p-5 lg:p-3 cursor-pointer text-2xl lg:text-lg border-l border-l-stroke text-text-foreground'>
        ...
        <p className='p-5 lg:p-3 cursor-pointer text-2xl lg:text-lg md:border-r  md:border-r-stroke border-l border-l-stroke text-text-foreground'>
      ...
      <div className='hidden md:block'>
        <p className='p-5 lg:p-3 cursor-pointer text-sm border-l border-l-stroke text-text-foreground'>
