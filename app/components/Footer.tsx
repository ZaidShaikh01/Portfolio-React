  ...
  return (
    <div className='flex  md:justify-between border-t border-t-stroke'>
      <div className='flex '>
        ...
        <p className='p-5 lg:p-3 cursor-pointer text-lg lg:text-lg border-l border-l-stroke text-text-foreground'>
        ...
        <p className='p-5 lg:p-3 cursor-pointer text-lg lg:text-lg md:border-r  md:border-r-stroke border-l border-l-stroke text-text-foreground'>
